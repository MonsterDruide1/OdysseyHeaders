...
public:
    ...
    GpuMemAllocator* getGpuMemAllocator() const {
        return mGpuMemAllocator;
    }

    ModelShaderHolder* getModelShaderHolder() const {
        return mModelShaderHolder;
    }
    ...
    ShadowDirector* getShadowDirector() const {
        return mShadowDirector;
    }

    PrepassTriangleCulling* getPrepassTriangleCulling() const {
