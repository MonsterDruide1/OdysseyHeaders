...
bool tryCheckShowCapMsgFlowerPotAfterImplant(const al::IUseSceneObjHolder*,
                                             CapMessageEnableChecker*);
bool tryShowCapMsgWorldWarpOut(const al::IUseSceneObjHolder*);
bool tryShowCapMsgShineChipGetFirst(const al::IUseSceneObjHolder*);
...
bool isShowCapMsgPlayerFallDead(const al::IUseSceneObjHolder*);
