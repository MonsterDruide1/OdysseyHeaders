...
public:
    ...
    struct GrowFlower {
        sead::FixedSafeString<128> pot_obj;
        sead::FixedSafeString<128> seed_obj;
        u64 time;
        u32 grow_level;
    };
    ...
    struct HintInfo {
        ...
        sead::FixedSafeString<128> stage_name;
        sead::FixedSafeString<128> obj_id;
        const char* scenario_name;
        sead::FixedSafeString<64> object_name;
        sead::Vector3f trans;
        sead::Vector3f original_trans;
        s64 _0x1a8 = 0;
        s64 _0x1b0 = 0;
        s64 _0x1b8 = 0;
        s64 _0x1c0 = 0;
        s32 main_scenario_no;
        s32 world_id;
        bool is_moon_rock;
        bool is_get;
        bool is_achievement;
        ...
        s32 unique_id;
        s32 hint_idx;
        sead::FixedSafeString<32> optional_id;
        sead::BitFlag32 progress_bit_flag;
        bool is_disabled;
        bool is_enable_hint_in_ceremony;
    };
    ...
    bool isPlayDemoWorldWarp() const { return _0x9f8 == 1; }
    ...
    bool get_0xa2c() const { return _0xa2c; }
...
public:
    ...
    UniqObjInfo* mGotCheckpoint = nullptr;
    sead::FixedSafeString<256> mCheckpointWarpObjId;
    s32* mPayShineNum = nullptr;
    bool mIsPayShineAllInAllWorld = false;
    s32 mKeyNum = 0;
    s32 mOpenDoorLockNum = 0;
    UniqObjInfo* mStartedObj = nullptr;
    SaveObjS32* mSaveObjS32 = nullptr;
    GrowFlower* mGrowFlower = nullptr;
    s32 mCoinNum = 0;
    s32 mTotalCoinNum = 0;
    s32 mPlayerJumpCount = 0;
    s32 mPlayerThrowCapCount = 0;
    s32* mUseCoinCollectNum = nullptr;
    s32* mUnlockedWorldId = nullptr;
    bool mIsPlayDemoOpening = true;
    bool mIsMeetCap = false;
    bool mIsEnableCap = true;
    bool* mIsExistSessionMember = nullptr;
    ...
    bool* mIsTalkLocalLanguage = nullptr;
    ...
    sead::FixedSafeString<64>* mItemCap = nullptr;
    sead::FixedSafeString<64>* mItemCloth = nullptr;
    sead::FixedSafeString<64>* mItemSticker = nullptr;
    sead::FixedSafeString<64>* mItemGift = nullptr;
    ...
    sead::FixedSafeString<128>* mHackDictionary = nullptr;
    bool mIsRideSphinx = false;
    bool mIsRideMotorcycle = false;
    s32* mScenarioNo = nullptr;
    ...
    sead::FixedSafeString<128> _0x908;
    HintInfo* mHintList = nullptr;
    ...
    bool _0x9ff = false;
    s32* mCoinCollectGotNum = nullptr;
    bool mIsEnterStageFirst = true;
    bool _0xa09 = false;
    bool mIsWarpCheckpoint = false;
    s32* mTotalShineNum = nullptr;
    s32* mTotalMoonRockShineNum = nullptr;
    ...
    MiniGameInfo* mMiniGameInfo = nullptr;
    ...
    sead::Vector3f _0xacc = sead::Vector3f::zero;
    bool _0xad8 = false;
    ...
    s32* mWorldMapIndex = nullptr;
    s32 mWorldMapNum = 0;
    s32* mWorldWarpIndex = nullptr;
    s32 mWorldWarpNum = 0;
