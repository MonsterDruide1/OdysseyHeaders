...
public:
    ...
    bool calcGravityCylinderCenterAxis(sead::Vector3f* outDir, f32* outDist,
    ...
    bool calcSnapPowerCube(sead::Vector3f* outDir, f32* outPower, const sead::Vector3f& pos,
                           f32 surfaceDistance) const;
    bool calcSnapPowerCylinder(sead::Vector3f* outDir, f32* outPower, const sead::Vector3f& pos,
                               f32 surfaceDistance) const;
